...
export default function DonorRegistrationForm() {
  ...
  const toggleDisease = (id: string) => {
    setForm((p) => ({
      ...p,
      diseases: p.diseases.includes(id)
        ? p.diseases.filter((d) => d !== id)
        : [...p.diseases, id],
    }));
  };
  ...
  const validate = () => {
    ...
    if (!form.name.trim() || form.name.trim().split(" ").length < 2)
      e.name = "أدخل الاسم الثنائي على الأقل";
    if (!form.gender) e.gender = "اختر الجنس";
    if (!form.age || +form.age < 18 || +form.age > 65)
      e.age = "العمر يجب أن يكون بين 18 و65 سنة";
    ...
    if (form.source === "campaign" && !form.campaignId)
      e.campaignId = "اختر الحملة";
    setErrors(e);
                ...
                <div className="mt-3 space-y-3 p-4 bg-orange-50 border border-orange-100 rounded-xl">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateField("deferredUntil", e.target.value)
                      }
                ...
                <div className="mt-3 space-y-3 p-4 bg-red-50 border border-red-100 rounded-xl">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateField("lockoutUntil", e.target.value)
                      }
