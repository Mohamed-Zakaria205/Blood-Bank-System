        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-3 text-center">
            {[
              ...
              <div key={i} className={`py-3 ${i < 2 ? 'border-l border-gray-100' : ''}`}>
                <div className="text-[#1E293B]" style={{ fontSize: '22px', fontWeight: 700 }}>
                  {s.value}
                </div>
          ...
          <div className="space-y-3 pt-2">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
              ...
              <span className="text-[#374151]" style={{ fontSize: '14px' }} dir="ltr">
                {donor.phone}
              </span>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
            ...
            <tbody>
              ...
              {filtered.map((donor) => (
                ...
                >
                  ...
                  <td className="px-5 py-4 text-gray-500" style={{ fontSize: '13px' }}>
                    {donor.age} سنة
                  </td>
                  <td className="px-5 py-4">
