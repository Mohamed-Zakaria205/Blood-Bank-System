            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={f.key}
                    className={f.key === "workingHours" ? "col-span-2" : ""}
                  >
                    <label
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSysInfo((p) => ({ ...p, [f.key]: e.target.value }))
                      }
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
              ...
              <div className="p-3 bg-blue-50 border border-blue-100 rounded-xl mb-5 flex items-start gap-2">
                ...
                <p className="text-blue-700" style={{ fontSize: "12px" }}>
                  يتم التحقق من كلمة المرور الحالية بواسطة الخادم — لا تُخزّن
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-3 max-w-sm">
                  ...
                  >
                    ...
                    >
                      <Sun
                        className={`w-5 h-5 ${!isDark ? "text-green-600" : "text-gray-400"}`}
                      />
                    </div>
              ...
              <div className="p-4 bg-green-50 border border-green-100 rounded-xl max-w-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      تصميم هادئ بخلفية خضراء داكنة مريحة للعين — مثالي
                      للاستخدام في البيئات الطبية ليلاً
                    </p>
                  </div>
                </div>
              </div>
