...
export default function AdminInventory() {
  ...
  if (isError)
    return (
      <ErrorState message="تعذر تحميل مخزون الدم" onRetry={() => refetch()} />
    );
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400" style={{ fontSize: "11px" }}>
                        الحد الأدنى: {b.minRequired} | آخر تحديث:{" "}
                        {b.lastUpdated}
                      </p>
                    </div>
                  </div>
              ...
              .map((b) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    >
                      فصيلة {b.type}: المخزون{" "}
                      {b.status === "critical" ? "في مستوى حرج" : "منخفض"}
                    </p>
                    <p
                      className={`${b.status === "critical" ? "text-red-500" : "text-yellow-600"}`}
                      style={{ fontSize: "13px" }}
                    >
                      متبقي {b.units} وحدات — الحد الأدنى المطلوب:{" "}
                      {b.minRequired} وحدة
                    </p>
                  </div>
                  <span
