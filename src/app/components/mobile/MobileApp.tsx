    ...
    <div className="flex flex-col h-full bg-[#F8F9FC]">
      ...
      <div className="bg-gradient-to-br from-[#C62828] to-[#B71C1C] px-6 pt-12 pb-10 text-center relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <h1 className="text-white mb-1" style={{ fontSize: '22px', fontWeight: 800 }}>
            بنك الدم
          </h1>
          <p className="text-red-200" style={{ fontSize: '14px' }}>
            تطبيق المتبرعين
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 px-5 pt-6 overflow-y-auto pb-6">
        <h2 className="text-[#1E293B] mb-1" style={{ fontSize: '20px', fontWeight: 700 }}>
          مرحباً بعودتك 👋
        </h2>
        ...
        <div className="space-y-4 mb-5">
          <div>
            <label
              className="block text-[#374151] mb-1.5"
        ...
        <button
          ...
          className="w-full py-4 rounded-2xl border-2 border-[#C62828] text-[#C62828] hover:bg-red-50 transition-all"
    ...
    <div className="flex flex-col h-full bg-[#F8F9FC]">
      <div className="bg-gradient-to-r from-[#C62828] to-[#B71C1C] px-6 pt-10 pb-6">
        <button
          ...
          className="w-8 h-8 bg-white/20 rounded-xl flex items-center justify-center mb-4"
        >
        ...
        <div className="flex gap-2 mb-4">
          {[1, 2, 3].map((s) => (
            <div
              key={s}
              className={`h-1.5 rounded-full flex-1 transition-all ${s <= step ? 'bg-white' : 'bg-white/30'}`}
            ></div>
          ))}
        </div>
        ...
        <p className="text-red-200" style={{ fontSize: '13px' }}>
          الخطوة {step} من 3
        </p>
      </div>
      ...
      <div className="flex-1 px-5 pt-6 overflow-y-auto pb-6">
        {step === 1 && (
          <div className="space-y-4">
            <h2 className="text-[#1E293B] mb-4" style={{ fontSize: '16px', fontWeight: 700 }}>
              المعلومات الشخصية
            </h2>
            <div>
              <label
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-white border border-gray-200 rounded-2xl px-4 py-3 focus:outline-none focus:border-[#C62828]"
                style={{ fontSize: '13px' }}
              >
                {['الرياض', 'جدة', 'مكة', 'الدمام', 'المدينة', 'الطائف', 'أبها'].map((c) => (
        ...
        <div className="relative">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="relative w-10 h-10 bg-white/20 rounded-2xl flex items-center justify-center"
            >
              <Bell className="w-5 h-5 text-white" />
              <span
                className="absolute -top-1 -left-1 w-4 h-4 bg-yellow-400 rounded-full flex items-center justify-center text-gray-900"
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 flex items-center gap-4">
            <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center flex-shrink-0 shadow-md">
              <span className="text-[#C62828]" style={{ fontSize: '18px', fontWeight: 800 }}>
                O+
              </span>
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span
                  className="bg-green-400/30 text-green-200 px-2 py-0.5 rounded-full"
                  style={{ fontSize: '11px' }}
                >
                  مؤهل الآن
                </span>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-1">
                  <Heart className="w-3.5 h-3.5 text-red-200" />
                  <span className="text-red-200" style={{ fontSize: '12px' }}>
                    8 تبرعات
                  </span>
                </div>
                <div className="flex items-center gap-1">
                  <Star className="w-3.5 h-3.5 text-yellow-300" />
                  <span className="text-yellow-200" style={{ fontSize: '12px' }}>
                    800 نقطة
                  </span>
                </div>
              </div>
      ...
      <div className="px-5 py-5 space-y-5 pb-24">
        ...
        >
          <div className="text-start">
            <div className="text-white mb-1" style={{ fontSize: '16px', fontWeight: 700 }}>
              احجز موعد تبرع
            </div>
            <div className="text-red-200" style={{ fontSize: '12px' }}>
              ساعد في إنقاذ حياة اليوم
            </div>
          </div>
        ...
        {/* Quick Actions */}
        <div>
          <h2 className="text-[#1E293B] mb-3" style={{ fontSize: '15px', fontWeight: 700 }}>
            الخدمات السريعة
          </h2>
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              {
                label: 'اختبار الأهلية',
                icon: Shield,
                screen: 'eligibility' as Screen,
                color: 'bg-green-50',
              ...
              >
                ...
                <span className="text-[#1E293B]" style={{ fontSize: '13px', fontWeight: 600 }}>
                  {action.label}
                </span>
              </button>
            ))}
        ...
        <div className="bg-red-50 border border-red-100 rounded-2xl p-4 flex items-center gap-3">
          ...
          <div className="flex-1">
            <div className="text-red-700" style={{ fontSize: '13px', fontWeight: 700 }}>
              🚨 طلب عاجل - فصيلة O-
            </div>
            <div className="text-red-500" style={{ fontSize: '12px' }}>
              مستشفى الملك فيصل يحتاج تبرعك الآن
            </div>
          </div>
          <button
            onClick={() => onNavigate('emergency')}
            className="bg-red-500 text-white px-3 py-1.5 rounded-xl"
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              >
                ...
                <div className="text-[#1E293B]" style={{ fontSize: '18px', fontWeight: 800 }}>
                  {stat.value}
                </div>
    ...
    <div className="flex flex-col h-full bg-[#F8F9FC]">
      ...
      <div className="flex-1 overflow-y-auto px-5 pt-5 pb-24 space-y-5">
        ...
        <div className="bg-green-50 border border-green-100 rounded-2xl p-4 flex items-center gap-3">
          ...
          <div>
            <div className="text-green-700" style={{ fontSize: '13px', fontWeight: 700 }}>
              أنت مؤهل للتبرع ✓
            </div>
            <div className="text-green-500" style={{ fontSize: '12px' }}>
              مرت 56 يوماً على آخر تبرع
            </div>
          </div>
          <button
            onClick={() => onNavigate('eligibility')}
            className="mr-auto text-green-600 underline"
            style={{ fontSize: '11px' }}
          >
            تفاصيل
          </button>
  ...
  return (
    <div className="flex flex-col h-full bg-[#F8F9FC] items-center justify-center p-6 text-center">
        ...
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <div key={i} className="text-center p-2 bg-gray-50 rounded-xl">
              <div className="text-gray-400 mb-1" style={{ fontSize: '11px' }}>
                {item.label}
              </div>
              <div className="text-[#1E293B]" style={{ fontSize: '13px', fontWeight: 600 }}>
                {item.value}
              </div>
            </div>
          ))}
      ...
      <div className="bg-yellow-50 border border-yellow-100 rounded-2xl p-4 w-full mb-6 text-start">
        <div className="text-yellow-700 mb-1" style={{ fontSize: '13px', fontWeight: 700 }}>
          ⚠️ تعليمات قبل التبرع:
        </div>
        <ul className="space-y-1">
          {[
            'شرب الماء بكثرة قبل الموعد',
            'تناول وجبة خفيفة',
            'إحضار بطاقة الهوية',
            'النوم الكافي ليلة السبق',
          ].map((t, i) => (
            <li
              key={i}
              className="text-yellow-600 flex items-center gap-1.5"
              style={{ fontSize: '12px' }}
            >
              <span>•</span>
              {t}
      ...
      <button
        onClick={() => onNavigate('home')}
        className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#C62828] to-[#B71C1C] text-white shadow-lg"
        style={{ fontSize: '15px', fontWeight: 700 }}
      >
        العودة للرئيسية
      </button>
...
function EligibilityScreen({ onNavigate }: { onNavigate: (s: Screen) => void }) {
  ...
  if (step >= questions.length) {
    ...
    return (
      <div className="flex flex-col h-full bg-[#F8F9FC]">
        <div
          className={`px-5 pt-10 pb-6 ${eligible ? 'bg-gradient-to-r from-[#388E3C] to-[#2E7D32]' : 'bg-gradient-to-r from-[#C62828] to-[#B71C1C]'}`}
        >
          <h1 className="text-white" style={{ fontSize: '20px', fontWeight: 700 }}>
            نتيجة الاختبار
          </h1>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-5 pb-24">
          <div
            className={`w-24 h-24 rounded-3xl flex items-center justify-center mx-auto mb-5 ${eligible ? 'bg-green-100' : 'bg-red-100'}`}
          >
            {eligible ? (
              <CheckCircle2 className="w-12 h-12 text-green-600" />
            ) : (
          ...
          <h2
            className={`mb-2 ${eligible ? 'text-green-700' : 'text-red-700'}`}
          ...
          <button
            onClick={() => (eligible ? onNavigate('book') : onNavigate('home'))}
    ...
    <div className="flex flex-col h-full bg-[#F8F9FC]">
      <div className="bg-gradient-to-r from-[#1E293B] to-[#334155] px-5 pt-10 pb-6">
        <button
          ...
          className="w-8 h-8 bg-white/10 rounded-xl flex items-center justify-center mb-4"
        >
          <ArrowLeft className="w-4 h-4 text-white" />
        </button>
        <div className="flex gap-1.5 mb-4">
          {questions.map((_, i) => (
            <div
              key={i}
              className={`h-1.5 rounded-full flex-1 transition-all ${i <= step ? 'bg-white' : 'bg-white/20'}`}
            ></div>
          ))}
        </div>
        ...
        <h1 className="text-white mt-1" style={{ fontSize: '16px', fontWeight: 700 }}>
          اختبار الأهلية للتبرع
        </h1>
      </div>
      <div className="flex-1 flex flex-col px-5 pt-8 pb-24">
        <div className="flex-1 flex flex-col items-center justify-center">
          ...
          <h2
            className="text-[#1E293B] text-center mb-8"
            style={{ fontSize: '18px', fontWeight: 700, lineHeight: '1.5' }}
          >
            {q.q}
          </h2>
          <div className="flex gap-4 w-full">
            ...
            <button
              onClick={() => {
                setAnswers({ ...answers, [q.key]: false });
                setStep(step + 1);
              }}
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            >
              ...
              <div className="text-[#1E293B]" style={{ fontSize: '20px', fontWeight: 800 }}>
                {s.v}
              </div>
              <div className="text-gray-400" style={{ fontSize: '11px' }}>
                {s.l}
            ...
            <div className="flex items-stretch">
              ...
              <div className="flex-1 p-4">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <div className="text-[#1E293B]" style={{ fontSize: '14px', fontWeight: 700 }}>
                      {h.type}
                    </div>
                  ...
                  <span
                    className={`px-2.5 py-1 rounded-full ${h.status === 'safe' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}
    ...
    <div className="flex flex-col h-full bg-[#F8F9FC] overflow-y-auto pb-24">
        ...
        <div className="flex justify-center gap-6 mt-4">
          {[
            ...
            <div key={i} className="text-center">
              <div className="text-white" style={{ fontSize: '20px', fontWeight: 800 }}>
                {s.v}
              </div>
              <div className="text-red-200" style={{ fontSize: '11px' }}>
                {s.l}
              </div>
            </div>
          ))}
      ...
      <div className="px-5 pt-5">
        ...
        <div className="flex gap-3 overflow-x-auto pb-2">
          {[
            ...
            <div
              key={i}
              className={`flex-shrink-0 ${b.color} border rounded-2xl p-3 text-center w-20`}
            >
              <div className="text-2xl mb-1">{b.icon}</div>
              <div className="text-gray-600" style={{ fontSize: '10px', fontWeight: 600 }}>
                {b.label}
              </div>
            </div>
          ))}
      ...
      <div className="px-5 pt-4 space-y-2">
        ...
        {[
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-[#1E293B]" style={{ fontSize: '14px', fontWeight: 600 }}>
                {item.value}
              </div>
            </div>
        ...
        <button
          ...
          className="w-full py-4 mt-4 rounded-2xl bg-red-50 border border-red-100 text-red-600 flex items-center justify-center gap-2"
          style={{ fontSize: '14px', fontWeight: 600 }}
        >
  ...
  return (
    <div className="flex flex-col h-full bg-[#F8F9FC]">
      <div className="bg-gradient-to-r from-[#F57C00] to-[#E65100] px-5 pt-10 pb-6">
        ...
        <p className="text-orange-200" style={{ fontSize: '13px' }}>
          أبطال التبرع بالدم
        </p>
      </div>
      ...
      <div className="px-5 py-3 bg-white border-b border-gray-100 flex gap-3 sticky top-0 z-10">
        <div className="flex bg-gray-100 rounded-xl overflow-hidden flex-1">
          {(['monthly', 'yearly'] as const).map((p) => (
            <button
              key={p}
              onClick={() => setPeriod(p)}
              className={`flex-1 py-2 text-xs font-semibold transition-all ${period === p ? 'bg-[#F57C00] text-white' : 'text-gray-500'}`}
            >
              {p === 'monthly' ? 'شهري' : 'سنوي'}
            </button>
          ))}
        ...
        <select
          ...
          className="bg-gray-100 rounded-xl px-3 py-2 focus:outline-none text-gray-600"
          style={{ fontSize: '12px' }}
        >
          ...
          {[leaderboard[1], leaderboard[0], leaderboard[2]].map((leader, i) => {
            ...
            return (
              <div key={leader.rank} className="flex flex-col items-center gap-2">
                ...
                <div
                  className={`${heights[i as keyof typeof heights]} ${colors[i as keyof typeof colors]} rounded-t-2xl w-16 flex items-center justify-center`}
                >
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-24 space-y-2">
        {leaderboard.map((leader) => (
          <div
            key={leader.rank}
            className={`bg-white rounded-2xl p-4 flex items-center gap-3 border shadow-sm ${leader.rank <= 3 ? 'border-yellow-100' : 'border-gray-100'}`}
          >
            <div
              className={`w-10 h-10 rounded-2xl flex items-center justify-center flex-shrink-0 ${leader.rank === 1 ? 'bg-yellow-100' : leader.rank === 2 ? 'bg-gray-100' : leader.rank === 3 ? 'bg-orange-100' : 'bg-gray-50'}`}
            >
              <span
                style={{
                  fontSize: '16px',
            ...
            <div className="w-10 h-10 bg-red-50 rounded-2xl flex items-center justify-center flex-shrink-0">
              <span className="text-[#C62828]" style={{ fontSize: '14px', fontWeight: 800 }}>
                {leader.name[0]}
              </span>
            </div>
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 text-gray-400">
                ...
                <span className="text-[#C62828]" style={{ fontSize: '11px' }}>
                  {leader.bloodType}
                </span>
              </div>
            </div>
            <div className="text-end">
              <div className="text-[#1E293B]" style={{ fontSize: '15px', fontWeight: 700 }}>
                {leader.donations}
              </div>
              <div className="text-gray-400" style={{ fontSize: '11px' }}>
                تبرع
      ...
      <div className="bg-gradient-to-r from-[#1E293B] to-[#334155] px-5 pt-10 pb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400" style={{ fontSize: '13px' }}>
            {notifs.filter((n) => !n.read).length} إشعارات جديدة
          </p>
        </div>
        <button
          onClick={() => setNotifs((n) => n.map((notif) => ({ ...notif, read: true })))}
          className="bg-white/10 px-3 py-1.5 rounded-xl text-white"
          style={{ fontSize: '12px' }}
        >
          قراءة الكل
        </button>
      ...
      <div className="flex-1 overflow-y-auto px-5 pt-4 pb-24 space-y-3">
        {notifs.map((notif) => (
          <div
            key={notif.id}
            onClick={() =>
              setNotifs((n) => n.map((nn) => (nn.id === notif.id ? { ...nn, read: true } : nn)))
            }
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                  ...
                  {!notif.read && (
                    <div className="w-2 h-2 bg-[#C62828] rounded-full flex-shrink-0 mt-1"></div>
                  )}
                </div>
                <div
                ...
                <div className="text-gray-400 mt-1.5" style={{ fontSize: '11px' }}>
                  {notif.time}
                </div>
              </div>
            </div>
    ...
    return (
      <div className="flex flex-col h-full bg-[#F8F9FC] items-center justify-center p-6 text-center">
        ...
        <p className="text-gray-500 mb-6" style={{ fontSize: '14px' }}>
          تم إرسال طلب التبرع الطارئ وستصل إشعارات للمتبرعين المؤهلين في منطقتك
        </p>
        <button
          onClick={() => onNavigate('home')}
          className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#C62828] to-[#B71C1C] text-white shadow-lg"
    ...
    <div className="flex flex-col h-full bg-[#F8F9FC]">
      <div className="bg-gradient-to-r from-[#C62828] to-[#B71C1C] px-5 pt-10 pb-6">
        ...
        <div className="flex items-center gap-2 bg-white/20 rounded-2xl px-3 py-2 mb-3 w-fit">
          ...
          <span className="text-yellow-200" style={{ fontSize: '13px', fontWeight: 600 }}>
            طلب طوارئ
          </span>
        </div>
        <h1 className="text-white" style={{ fontSize: '20px', fontWeight: 700 }}>
        ...
        <p className="text-red-200" style={{ fontSize: '13px' }}>
          سيصل الطلب للمتبرعين المؤهلين فوراً
        </p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-5 pt-5 pb-24 space-y-4">
        ...
        <div>
          ...
          <div className="flex gap-2">
            {[1, 2, 3, 5, 10].map((n) => (
              <button
                key={n}
                onClick={() => setFormData({ ...formData, units: n })}
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="اشرح سبب الطلب الطارئ..."
            className="w-full bg-white border border-gray-200 rounded-2xl px-4 py-3 focus:outline-none focus:border-[#C62828] resize-none shadow-sm"
            style={{ fontSize: '14px' }}
          />
        </div>
  ...
  return (
    <div className="flex flex-col h-full bg-[#F8F9FC]">
      <div className="bg-gradient-to-r from-[#1565C0] to-[#1976D2] px-5 pt-10 pb-6">
        ...
        <p className="text-blue-200" style={{ fontSize: '13px' }}>
          الرياض - حيك الحالي
        </p>
      </div>
      ...
      {/* Map Placeholder */}
      <div
        className="mx-5 mt-4 bg-blue-50 rounded-2xl overflow-hidden border border-blue-100 shadow-sm"
        style={{ height: '160px' }}
      >
        <div className="w-full h-full flex items-center justify-center relative">
          ...
          <div className="relative text-center">
            ...
            <p className="text-blue-600" style={{ fontSize: '13px', fontWeight: 600 }}>
              خريطة تفاعلية
            </p>
            <p className="text-blue-400" style={{ fontSize: '11px' }}>
              4 بنوك دم في محيط 10 كم
            </p>
          </div>
          {/* Map dots */}
          {[
            ...
            <div
              key={i}
              className="absolute w-4 h-4 bg-red-500 rounded-full border-2 border-white shadow-md animate-pulse"
      ...
      <div className="flex-1 overflow-y-auto px-5 pt-4 pb-24 space-y-3">
        <div className="flex items-center gap-2 mb-1">
          <h2 className="text-[#1E293B]" style={{ fontSize: '15px', fontWeight: 700 }}>
            بنوك الدم القريبة
          </h2>
          <span
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span
                    className={`px-2 py-0.5 rounded-full ${bank.open ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-600'}`}
                    style={{ fontSize: '11px', fontWeight: 600 }}
                  >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex gap-1.5">
                    {bank.types.map((t) => (
                      <span
                        key={t}
                        className="bg-red-50 text-[#C62828] px-2 py-0.5 rounded-lg"
                        style={{ fontSize: '11px', fontWeight: 600 }}
                      >
                        {t}
                      </span>
...
export default function MobileApp() {
  ...
  const renderScreen = () => {
    switch (screen) {
      ...
      case 'book':
        return <BookScreen onNavigate={setScreen} />;
      case 'bookSuccess':
        return <BookSuccessScreen onNavigate={setScreen} />;
      case 'eligibility':
        return <EligibilityScreen onNavigate={setScreen} />;
      case 'history':
      ...
      case 'emergency':
        return <EmergencyScreen onNavigate={setScreen} />;
      case 'map':
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-[#1E293B] via-[#2D3748] to-[#1E293B] flex items-center justify-center p-4"
      dir="rtl"
    >
      {/* Back button */}
      <button
        onClick={() => navigate('/')}
        className="absolute top-6 right-6 flex items-center gap-2 text-white/60 hover:text-white transition-colors z-10"
      >
      ...
      <div className="text-center mb-6 absolute top-6 left-1/2 -translate-x-1/2">
        <p className="text-white/50" style={{ fontSize: '13px' }}>
          تطبيق المتبرع - محاكاة شاشة الهاتف
        </p>
      </div>
      ...
      <div className="relative">
        ...
        <div className="bg-[#0F0F0F] rounded-[50px] p-3 shadow-2xl" style={{ width: '380px' }}>
          {/* Status bar notch */}
          <div
            className="bg-black rounded-[44px] overflow-hidden relative"
            style={{ height: '780px' }}
          >
            {/* Status bar */}
            ...
            {showNav && (
              <div
                className="absolute bottom-0 inset-x-0 bg-white border-t border-gray-100 z-20 safe-area-bottom"
              ...
              >
                <div className="flex items-center justify-around px-2 pt-2">
                  {navItems.map((item) => {
                    const isActive =
                      screen === item.id ||
                      (item.id === 'home' && screen === 'book') ||
                      (item.id === 'home' && screen === 'map') ||
                      (item.id === 'home' && screen === 'emergency');
                    return (
                      <button
                        key={item.id}
                      ...
                      >
                        <div
                          className={`w-10 h-10 rounded-2xl flex items-center justify-center transition-all ${isActive ? 'bg-[#C62828]' : 'bg-transparent'}`}
                        >
                          <item.icon
                        ...
                        <span
                          className={`${isActive ? 'text-[#C62828]' : 'text-gray-400'}`}
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-wrap gap-2 justify-center max-w-xl px-4">
        {[
          { s: 'login', l: 'تسجيل دخول' },
          { s: 'register', l: 'إنشاء حساب' },
          { s: 'home', l: 'الرئيسية' },
          { s: 'book', l: 'حجز موعد' },
          { s: 'eligibility', l: 'اختبار الأهلية' },
          { s: 'history', l: 'السجل' },
          { s: 'leaderboard', l: 'المتصدرون' },
          { s: 'notifications', l: 'الإشعارات' },
          { s: 'emergency', l: 'طوارئ' },
          { s: 'map', l: 'الخريطة' },
          ...
          <button
            key={item.s}
            onClick={() => setScreen(item.s as Screen)}
