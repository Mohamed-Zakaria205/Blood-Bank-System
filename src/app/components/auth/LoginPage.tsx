...
import {
  Droplet, Eye, EyeOff, Lock, Mail, AlertCircle,
  ShieldCheck, Stethoscope, FlaskConical, Package,
  Activity, Users, TestTube2, Shield,
} from 'lucide-react';
    ...
    >
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 right-1/4 w-[300px] h-[300px] rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(22,163,74,0.04) 0%, transparent 70%)' }} />
      </div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full p-10">
          ...
          <div className="flex items-center gap-3 mb-12">
            ...
            <div>
              <p style={{ fontSize: '24px', fontWeight: 800, color: 'white', letterSpacing: '-0.3px' }}>
                BloodLink
              </p>
          ...
          <div className="flex-1 flex flex-col justify-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/20 mb-5 w-fit"
              style={{ background: 'rgba(255,255,255,0.1)' }}>
              <div className="w-2 h-2 rounded-full bg-green-300 animate-pulse" />
              <span style={{ fontSize: '12px', fontWeight: 600, color: '#bbf7d0' }}>محافظة بني سويف</span>
            </div>

            <h2 style={{ fontSize: '38px', fontWeight: 800, lineHeight: '1.25', color: 'white', marginBottom: '14px' }}>
              منصة طبية<br />
              <span style={{ color: '#86efac' }}>متكاملة للدم</span>
            </h2>
            <p style={{ fontSize: '15px', lineHeight: '1.7', color: '#bbf7d0', maxWidth: '360px', marginBottom: '36px' }}>
            ...
            <div className="grid grid-cols-4 gap-2">
              {stats.map(({ icon: Icon, value, label }) => (
                <div key={label} className="text-center p-3 rounded-xl"
                  ...
                  <div style={{ fontSize: '9px', color: '#86efac', lineHeight: '1.3' }}>{label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-5 lg:p-10">
        <div className="w-full max-w-[440px]">
          ...
          {/* Greeting */}
          <div className="mb-7">
            <h2 style={{ fontSize: '28px', fontWeight: 800, color: '#111827', marginBottom: '6px' }}>
              مرحباً بك 👋
            </h2>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {/* Password badge */}
                        <span className="inline-block px-1.5 py-0 rounded"
                          style={{
          ...
          {/* Footer note */}
          <div className="mt-6 p-4 rounded-xl border border-gray-100 text-center"
