...
## 4. Donations Filter API Requirements

This section outlines the API specifications and query parameters that the backend needs to implement for the updated Donations list filters (GET `/donations`).
